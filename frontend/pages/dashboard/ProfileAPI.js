...
const getProfile = () => ProfileCache.get();

export const ProfileAPI = {
    isProfileAvailable: () => ProfileCache.isValid(),
    getStudentId: () => (getProfile() || {}).student_id,
    getStudentName: () => (getProfile() || {}).student_name,
    getCollege: () => (getProfile() || {}).college,
    getMajor: () => (getProfile() || {}).major,
    getClassName: () => (getProfile() || {}).class_name,
};
